...
/**
 * A class, that creates sample data, which is going to be stored in the ISE database.
 */
public final class IseCatalogSampleData {
  public static List<Ise.Item> createItemList() {
    return Arrays.asList(
        ...
        Ise.Item.newBuilder().setId("ci1-b210").setType(BOOK)
            ...
            .addSkus(Ise.Sku.newBuilder().setId("1").setLanguage("en").setTitle("War and Peace")
                .addEntries(Ise.Entry.newBuilder()
                    .setId("1")
                    .setCreatedTimestamp(date("2012-09-24"))
                ...
                .addEntries(Ise.Entry.newBuilder()
                    .setId("2")
                    .setCreatedTimestamp(date("2012-09-25"))
                    .build()))
            .addSkus(Ise.Sku.newBuilder().setId("2").setLanguage("ru").setTitle("Война и мир")
                .addEntries(Ise.Entry.newBuilder()
                    .setCreatedTimestamp(date("2012-11-05"))
                    .setDownloadInfo(Ise.DownloadInfo.newBuilder()
                        .setDownloadType("librus")
                        .setDownloadId("1011")
                        .setOriginId("15")
        ...
        Ise.Item.newBuilder().setId("ci1-B250").setType(BOOK)
            ...
            .addSkus(Ise.Sku.newBuilder().setId("1").setLanguage("en").setTitle("The Land of Crimson Clouds")
                .addEntries(Ise.Entry.newBuilder()
                    .setCreatedTimestamp(date("2012-11-02"))
                    .setDownloadInfo(Ise.DownloadInfo.newBuilder()
                        .setDownloadType("librus")
                        .setDownloadId("1024")
                        .setOriginId("15")
            ...
            .addSkus(Ise.Sku.newBuilder().setId("2").setLanguage("ru").setTitle("Страна багровых туч")
                .addEntries(Ise.Entry.newBuilder()
                    .setCreatedTimestamp(date("2012-10-24"))
                    .setDownloadInfo(Ise.DownloadInfo.newBuilder()
                        .setDownloadType("librus")
                        .setDownloadId("1025")
                        .setOriginId("15")
  ...
  private static long date(String strDate) {
    final SimpleDateFormat fmt = new SimpleDateFormat("yyyy-MM-dd");
    fmt.setTimeZone(TimeZone.getTimeZone(ZoneId.of("Z")));
    try {
      return fmt.parse(strDate).getTime();
