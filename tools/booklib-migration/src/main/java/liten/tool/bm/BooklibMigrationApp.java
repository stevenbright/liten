 ...
 * Entry point.
 */
public final class BooklibMigrationApp {

  public static void main(String[] args) throws Exception {
    final String[] contextPaths = {"classpath:/tool/spring/app-context.xml"};
  ...
  private static void addEnvironmentProperties(ConfigurableApplicationContext context) throws IOException {
    ...
    resources.add(context.getResource("classpath:/tool/core.properties"));
